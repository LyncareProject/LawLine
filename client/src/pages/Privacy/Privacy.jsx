...
const Privacy = () => {
  return (
    <div className={styles.Privacy}>
      ...
      <p className={styles.Desc}>
        1{")"} “복대리”라 함은 회사가 대한민국 변호사 자격 소지자 및 그 외
        회사가 지정하는 자를 대상으로 제공하는 어플리케이션 및 웹 서비스를
        지칭합니다.
      </p>
      <p className={styles.Desc}>
        2{")"} “회원”이라 함은 서비스를 이용하고자 가입을 신청하고 회사가 그
        신청을 처리해 계정이 등록된 자를 말합니다.
      </p>
      <p className={styles.Desc}>
      ...
      <p className={styles.Desc}>
        4{")"} “복대리 회원”이라 함은 복대리의 서비스 이용약관에 동의하여
        회원으로 가입한 변호사를 말합니다.
      </p>
      <p className={styles.Desc}>
      ...
      <p className={styles.Desc}>
        1. 회원이 LawLine에서 제공하는 방식을 통해 복대리 회원과 법률상담 등 계약을
        체결하는 서비스
      </p>
      <p className={styles.Desc}>
      ...
      <h3 className={styles.SubTitle}>
        제2절 회원과 복대리 회원 간 법률상담 등 계약체결 서비스
      </h3>
      <h3 className={styles.SubTitle}>
        제16조 (회원과 복대리 회원 간 법률상담 등 계약체결)
      </h3>
      <p className={styles.Desc}>
        ① 회원과 복대리 회원의 법률상담 등 계약체결의 방식은 다음과 같습니다.
      </p>
      <p className={styles.Desc}>
        가. LawLine에서 제공하는 절차에 따라 회원이 필수 및 선택항목들을 기재하여
        청약을 하면 복대리 회원의 승낙의 과정을 거쳐 계약이 체결되는 방식
      </p>
      <p className={styles.Desc}>
        나. 회사가 제공하는 절차에 따라 회원이 필수 및 선택항목들을 기재하여
        청약의 유인을 하면 복대리 회원의 청약 과정을 거쳐 회원의 승낙을 통해
        계약이 체결되는 방식
      </p>
      <p className={styles.Desc}>
      ...
      <p className={styles.Desc}>
        회원과 복대리 회원 사이의 계약에 대해 회사는 어떠한 법률상 책임을 지지
        않으며, 또한 회원과 복대리 회원의 각 회사와의 법률상 관계는(이용해지 등)
        회원과 복대리 회원 사이에 체결된 법률상담 등 계약에 영향을 미치지
        않습니다.
      </p>
      ...
      <p className={styles.Desc}>
        ...
        회원의 정보를 복대리 회원에게 제공할 수 있습니다.
      </p>
      <h3 className={styles.SubTitle}>제21조 (회원의 의무)</h3>
      <p className={styles.Desc}>
        ① 회원은 LawLine을 통해 연결된 복대리 회원에게 법률상담 비용지급 등 계약에
      ...
      <p className={styles.Desc}>
        ④ 회원은 LawLine을 통해 연결된 복대리 회원에게 약정한 비용을 직접
        지불하여야 합니다.
      </p>
      <p className={styles.Desc}>
      ...
      <p className={styles.Desc}>
        1{")"} 회사가 제공하는 복대리 이용방법에 의하지 아니하고 비정상적인
      ...
      <p className={styles.Desc}>
        ① 회사가 회원과 복대리 회원 사이의 법률상담 등 계약을 중개하는 경우,
        회사는 이를 중개하는 시스템을 운영•관리•제공할 뿐이며, 상기 계약 당사자
        중 일방을 대리하지 않습니다. 이 경우, 회원과 복대리 회원 사이에 성립된
      ...
      <p className={styles.Desc}>
        ④ 회사는 회사의 중개에 따라 회원과 복대리 회원 간 이루어진 거래와
      ...
      <p className={styles.Desc}>
        ...
        기간통신사업자의 회선 장애 또는 이에 준하는 불가항력으로 인하여 복대리를
        제공할 수 없는 경우에는 복대리 제공에 관한 책임이 면제됩니다.
      </p>
      <p className={styles.Desc}>
