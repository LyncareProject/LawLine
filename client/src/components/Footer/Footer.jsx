        ...
        <div className={styles.body}>
          <div className={styles.flex}>
            <div className={styles.left}>
              ...
              <p>CEO : 김종식, 김수은 ・ wevibeinc@gmail.com</p>
              <p>
                사업자번호 : 477-87-01651 ・ 통신번호 : 제 2023-서울금천-1254호
          ...
          <div className={styles.responsibility}>
            <p>
              ...
              앞서 반드시 법률전문가와 충분한 상담을 진행하시기 바랍니다. 모든
              법률상담은 로라인에 가입한 변호사 회원이 직접 진행합니다. 로라인에
              표시된 변호사 회원의 정보는 해당 변호사 회원이 직접 제공한 것이며,
              모든 변호사 회원은 소속 법률사무소에서 독립적으로 업무를
              수행합니다.
            </p>
